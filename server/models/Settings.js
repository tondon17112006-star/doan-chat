...
const settingsSchema = createStringIdSchema(
  {
    value: {
      ...
      notifications: {
        messages: { type: Boolean, default: true }, calls: { type: Boolean, default: true }, friendRequests: { type: Boolean, default: true }, sound: { type: Boolean, default: true }, desktop: { type: Boolean, default: false }, privateMode: { type: Boolean, default: false },
      },
      privacy: {
